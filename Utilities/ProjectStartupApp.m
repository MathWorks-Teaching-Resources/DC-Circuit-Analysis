classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "DC-Circuit-Analysis";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to DC Circuit Analysis';
            ...
            app.Image.ImageSource = 'image_11.png';
            ...
            app.ReviewTitle.Text = 'Welcome to DC Circuit Analysis';
